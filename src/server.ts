...
import recycleGalleryRoutes from "./routes/GalleryRecycleBinRoutes"
...
app.use(
  cors({
    origin: ["http://localhost:5173", "http://69.62.70.22:8000/", "http://69.62.70.22:3000"],
    credentials: true,
...
app.use("/api/v1/Galleryrecyclebin",recycleGalleryRoutes);
app.use("/api/v1/bankAccount",bankRoutes)
